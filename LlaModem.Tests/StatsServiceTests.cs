...
public class StatsServiceTests : IDisposable
{
    ...
    {
        await SeedDataAsync(
            (MakeTimestamp(0, 10), "llama3.2", "/v1/chat/completions", 10, 50, 60, 100.0, 200.0, 0, 200, "10.0.0.1"),
            (MakeTimestamp(0, 11), "llama3.2", "/v1/chat/completions", 20, 100, 120, 150.0, 300.0, 0, 200, "10.0.0.2"));
        var persistence = new SqliteUsagePersistence(new Microsoft.Extensions.Options.OptionsWrapper<LlaModem.Config.UsageConfig>(new LlaModem.Config.UsageConfig { Path = _tempDb }));
        var result = await new StatsService(persistence).GetDailyUsageAsync(30, null);

        Assert.Single(result.Daily);
        var r = result.Daily[0];
        Assert.Equal(DateTime.Now.Date.ToString("yyyy-MM-dd"), r.Date);
    ...
    {
        await SeedDataAsync(
            (MakeTimestamp(0, 10), "llama3.2", "/v1/chat/completions", 10, 50, 60, 100.0, 200.0, 0, 200, null),
            (MakeTimestamp(0, 11), "mistral", "/v1/chat/completions", 20, 100, 120, 150.0, 300.0, 0, 200, null));
        var result = await CreateService().GetDailyUsageAsync(30, null);
    ...
    {
        await SeedDataAsync(
            (MakeTimestamp(2, 10), "llama3.2", "/v1/chat/completions", 10, 50, 60, 100.0, 200.0, 0, 200, null),
            (MakeTimestamp(1, 10), "llama3.2", "/v1/chat/completions", 20, 100, 120, 150.0, 300.0, 0, 200, null),
            (MakeTimestamp(0, 10), "llama3.2", "/v1/chat/completions", 30, 150, 180, 200.0, 400.0, 0, 200, null));
        var result = await CreateService().GetDailyUsageAsync(30, null);
    ...
    public async Task GetDailyUsageAsync_NoCacheHits_ReturnsRate0()
    {
        await SeedDataAsync(
            (MakeTimestamp(0, 10), "llama3.2", "/v1/chat/completions", 10, 50, 60, 100.0, 200.0, 0, 200, null),
            (MakeTimestamp(0, 11), "llama3.2", "/v1/chat/completions", 20, 100, 120, 150.0, 300.0, 0, 200, null));
        var result = await CreateService().GetDailyUsageAsync(30, null);
    ...
    {
        await SeedDataAsync(
            (MakeTimestamp(2, 10), "llama3.2", "/v1/chat/completions", 10, 50, 60, 100.0, 200.0, 0, 200, "10.0.0.1"),
            (MakeTimestamp(0, 10), "mistral", "/v1/chat/completions", 20, 100, 120, 150.0, 300.0, 0, 200, "10.0.0.2"),
            (MakeTimestamp(1, 10), "llama3.2", "/v1/chat/completions", 30, 150, 180, 200.0, 400.0, 0, 200, "10.0.0.3"));
        var result = await CreateService().GetRecentRequestsAsync(10, 0, null);
    ...
    {
        await SeedDataAsync(
            (MakeTimestamp(4, 10), "llama3.2", "/v1/chat/completions", 10, 50, 60, null, null, null, 200, null),
            (MakeTimestamp(3, 10), "llama3.2", "/v1/chat/completions", 20, 100, 120, null, null, null, 200, null),
            (MakeTimestamp(2, 10), "llama3.2", "/v1/chat/completions", 30, 150, 180, null, null, null, 200, null),
            (MakeTimestamp(1, 10), "llama3.2", "/v1/chat/completions", 40, 200, 240, null, null, null, 200, null),
            (MakeTimestamp(0, 10), "llama3.2", "/v1/chat/completions", 50, 250, 300, null, null, null, 200, null));
    ...
    {
        await SeedDataAsync(
            (MakeTimestamp(0, 10), "llama3.2", "/v1/chat/completions", 10, 50, 60, null, null, null, 200, null),
            (MakeTimestamp(1, 10), "mistral", "/v1/chat/completions", 20, 100, 120, null, null, null, 200, null),
            (MakeTimestamp(2, 10), "llama3.2", "/v1/chat/completions", 30, 150, 180, null, null, null, 200, null));
    ...
    public async Task GetDailyUsageAsync_ModelFilter_ReturnsOnlyMatchingModel()
    {
        await SeedDataAsync(
            (MakeTimestamp(0, 10), "llama3.2", "/v1/chat/completions", 10, 50, 60, 100.0, 200.0, 0, 200, null),
            (MakeTimestamp(0, 11), "mistral", "/v1/chat/completions", 20, 100, 120, 150.0, 300.0, 0, 200, null),
            (MakeTimestamp(0, 12), "llama3.2", "/v1/chat/completions", 30, 150, 180, 200.0, 400.0, 0, 200, null));
        var service = CreateService();
    ...
    {
        await SeedDataAsync(
            (MakeTimestamp(0, 10), "llama3.2", "/v1/chat/completions", 10, 50, 60, 100.0, 200.0, 1, 200, null),
            (MakeTimestamp(0, 11), "llama3.2", "/v1/chat/completions", 20, 100, 120, 150.0, 300.0, 0, 200, null),
            (MakeTimestamp(0, 12), "llama3.2", "/v1/chat/completions", 30, 150, 180, 200.0, 400.0, 1, 200, null));
        var result = await CreateService().GetDailyUsageAsync(30, null);
    ...
    {
        await SeedDataAsync(
            (MakeTimestamp(0, 10), "llama3.2", "/v1/chat/completions", 10, 50, 60, 100.0, 200.0, 5, 200, null),
            (MakeTimestamp(0, 11), "llama3.2", "/v1/chat/completions", 20, 100, 120, 150.0, 300.0, 3, 200, null));
        var result = await CreateService().GetDailyUsageAsync(30, null);
    ...
    {
        await SeedDataAsync(
            (MakeTimestamp(0, 10), "llama3.2", "/v1/chat/completions", 10, 50, 60, 120.5, 450.3, 5, 200, "192.168.1.100"));
        var result = await CreateService().GetRecentRequestsAsync(10, 0, null);
    ...
    {
        await SeedDataAsync(
            (MakeTimestamp(1, 10), "llama3.2", "/v1/chat/completions", 10, 50, 60, 100.0, 200.0, 1, 200, null),
            (MakeTimestamp(1, 11), "llama3.2", "/v1/chat/completions", 20, 100, 120, 150.0, 300.0, 0, 200, null),
            (MakeTimestamp(1, 12), "mistral", "/v1/chat/completions", 30, 150, 180, 200.0, 400.0, 1, 200, null),
            (MakeTimestamp(0, 10), "llama3.2", "/v1/chat/completions", 40, 200, 240, 250.0, 500.0, 0, 200, null),
            (MakeTimestamp(0, 11), "mistral", "/v1/chat/completions", 50, 250, 300, 300.0, 600.0, 0, 200, null));
        var result = await CreateService().GetDailyUsageAsync(30, null);

        Assert.Equal(4, result.Daily.Length);
        var may10llama = result.Daily.First(r => r.Date == DateTime.Now.AddDays(-1).Date.ToString("yyyy-MM-dd") && r.Model == "llama3.2");
        var may10mistral = result.Daily.First(r => r.Date == DateTime.Now.AddDays(-1).Date.ToString("yyyy-MM-dd") && r.Model == "mistral");
        var may11llama = result.Daily.First(r => r.Date == DateTime.Now.Date.ToString("yyyy-MM-dd") && r.Model == "llama3.2");
        var may11mistral = result.Daily.First(r => r.Date == DateTime.Now.Date.ToString("yyyy-MM-dd") && r.Model == "mistral");
