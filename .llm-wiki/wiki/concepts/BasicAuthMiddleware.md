...
updated: 2026-05-19
sources:
  - [[sources/SRC-2026-05-18-006]]
status: complete
---

# BasicAuthMiddleware

**Description:** Validates HTTP Basic Auth credentials on `/v1/*` proxy routes. Blocks unauthenticated access to OpenAI-compatible endpoints while leaving admin endpoints (`/admin/*`) open.
...
**Source:** [[entities/ConfigRecords]] records:
...
See [[concepts/LlaModem.Tests]] for test examples.
