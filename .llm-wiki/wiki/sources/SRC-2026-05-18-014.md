...
- Values auto-typed and injected at JSON root level by [[entities/HeaderValueInjector]]
...
- [[entities/ConfigRecords]] — Configuration records summary
- [[entities/HeaderValueInjector]] — Header injection configuration
- [[entities/DefaultModelLauncher]] — PowerShell script paths
- [[entities/UsageService]] — Usage tracking configuration
