...
**Middleware:** [[entities/ResponseUsageMiddleware]] (see `.rpiv/guidance/Middleware/ResponseUsageMiddleware.md`)
...
- [[entities/UsageExtractor]] — Token usage parsing from responses
- [[entities/ResponseUsageMiddleware]] — Usage capture middleware
- [[entities/StatsService]] — Usage aggregation and cost comparison
- [[entities/DashboardService]] — Admin endpoints for stats queries
