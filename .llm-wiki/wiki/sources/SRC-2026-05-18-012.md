...
- [[entities/UsageExtractor]] — Usage extraction tests
- [[entities/HeaderValueInjector]] — Header injection tests
- [[entities/RequestForwarder]] — Proxy logic tests
- [[entities/StatsService]] — Aggregation tests
